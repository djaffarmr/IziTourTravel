package com.template_c.app.features;
...
import com.template_c.app.MainActivity;
import com.template_c.app.R;

/**
 * Created by Djaffar on 7/10/2017.
 */

public class Agen extends AppCompatActivity {
    // local variables
    WebView webView;
    ...
    public void LoadWeb() {
        ...
        // url to load
        webView.loadUrl("http://izitourtravel.com/peluang-usaha");
    ...
    public void HomeBtn() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Agen.this, MainActivity.class);
